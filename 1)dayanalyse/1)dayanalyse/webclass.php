			...
			switch ($month) {
				...
				//2)
			 	...
			 	switch ($firstDayOfWeek ) {
					...
					case 'Tuesday':
					$firstDayOfWeek = 'Вторник';
					break;
					 
					case 'Wednesday':
					$firstDayOfWeek = 'Среда';
					break;
					 
					case 'Thursday':
					$firstDayOfWeek = 'Четверг';
					break;
					 
					case 'Friday':
					$firstDayOfWeek = 'Пятница';
					break;
					 
					case 'Saturday':
					$firstDayOfWeek = 'Суббота';
				...
				switch ($lastDayOfWeek ) {
					case 'Monday':
					$lastDayOfWeek = 'Понедельник';
					break;
					 
					case 'Tuesday':
					$lastDayOfWeek = 'Вторник';
					break;
					...
					case 'Thursday':
					$lastDayOfWeek = 'Четверг';
					break;
					 
					case 'Friday':
					$lastDayOfWeek = 'Пятница';
					break;
					 
					case 'Saturday':
					$lastDayOfWeek = 'Суббота';
					 
					break;
					case 'Sunday':
					$lastDayOfWeek = 'Воскресенье';
